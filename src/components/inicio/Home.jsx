...
const Home = () => {
  return (
    <section className="h-auto w-full flex flex-col items-start px-5 text-gray-50 py-10 my-10 gap-4 md:h-[60vh] md:justify-center md:items-center   max-w-4xl" id='inicio'>
        <div className='bg-neutral-700 w-auto h-auto rounded-3xl py-2 px-3 animate-fade-left animate-once animate-ease-in-out'><span className='bg-orange-500 px-2  py-1 rounded-xl font-semibold'>15% OFF</span> El plan mas eficiente para tu meta</div>
