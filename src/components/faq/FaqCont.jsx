...
const FaqCont = () => {
  ...
  return (
    <section className='h-auto w-full flex flex-col items-start px-3 text-gray-50 py-5 gap-4 border-t-2 border-orange-600 my-10' id="preguntas">
            ...
            acordionData.map((acc, index) => {
               return(
                <div className="accordion w-full" onClick={() => handleActive(index)} key={index}>
                    <div className="accordionHeading flex bg-orange-600 w-full px-5 rounded-md gap-4 items-center py-2">
