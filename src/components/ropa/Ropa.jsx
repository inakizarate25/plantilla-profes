...
const Ropa = () => {
  return (
    <section className='border-t-2 border-orange-600 py-4 my-8 flex flex-wrap items-center justify-around gap-10'>
        ...
        <a className='px-4 py-3 text-2xl text-gray-100 font-semibold bg-orange-600 rounded-md animate-fade-right animate-once animate-ease-in-out' href="https://www.instagram.com/legenderfit/">Ver Productos</a>
    </section>
  )
}
